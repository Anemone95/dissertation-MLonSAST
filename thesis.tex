...
\studentnum{\snum}
\grade{2018}
\advisor{\kaishu 陈振宇~~教授~~房春荣~~助理研究员}

\major{\kaishu 工程硕士（软件工程领域）}
\researchfield{\kaishu 软件工程}
\footdate{\kaishu 2020~年~5~月}
\submitdate{\kaishu 2020~年~5~月~23~日}
\defenddate{\kaishu 2020~年~5~月~23~日}
...
\englishadvisorM{Professor}
\englishadvisor{Research Assistant}
\englishadvisornameM{~~Zhenyu Chen}
