...
\begin{figure}[htbp]
    ...
    \end{minipage}
    \caption{SliceWalaClassLoader 代码实现}\label{code:sliceWalaClassLoader}
    \vspace{-0.5cm}
\end{figure}
...
\begin{figure}[htbp]
    ...
    \end{minipage}
    \caption{自定义 JavaClassLoader}\label{code:sliceJavaClassLoader}
\end{figure}
...
\begin{figure}[htbp]
    ...
    \end{minipage}
    \caption{NodeLimitPruner 的实现}\label{code:slicePruner}
\end{figure}
...
\begin{figure}[htbp]
    ...
    \end{minipage}
    \caption{建立单词表和向量化的实现片}\label{code:preTokenize}
\end{figure}
...
\begin{figure}[htbp]
    ...
    \end{minipage}
    \caption{DataLoader 的加载器}\label{code:collateFn}
\end{figure}
